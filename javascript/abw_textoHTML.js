...
console.log($whatIsDom);//<p id="que-es">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut assumenda, ipsum accusantium fuga recusandae, id officiis fugit asperiores nam sequi odio natus provident quas voluptatum ipsa. Ducimus laboriosam ad et.</p>
/*
...
//Modificar el texto con textContent (Estandar):
...
//Modificar el texto con innerHTML (Se reenderiza como codigo html, a diferencia de textContent):
...
la estructura del documento HTML. Una página HTML está formada por múltiples
...
Cuando comenzamos en el mundo del desarrollo web, normalmente comenzamos por
aprender a escribir etiquetado o marcado HTML y además, añadir estilos CSS para
darle color, forma y algo de interacción. Sin embargo, a medida que avanzamos,
nos damos cuenta que en cierta forma podemos estar bastante limitados.

Si únicamente utilizamos HTML/CSS, sólo podremos crear
páginas «estáticas» (sin demasiada personalización por parte del usuario),
pero si añadimos Javascript, podremos crear páginas «dinámicas».
Cuando hablamos de páginas dinámicas, nos referimos a que podemos dotar de la
potencia y flexibilidad que nos da un lenguaje de programación para crear
documentos y páginas mucho más ricas, que brinden una experiencia más completa
y con el que se puedan automatizar un gran abanico de tareas y acciones.
*/
